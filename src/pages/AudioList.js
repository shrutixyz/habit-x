  ...
  const list = [
    {
      ...
      imgUrl:
        "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP._yAzxPxW9ZXdr2Bp7Ujh8wHaHQ%26pid%3DApi&f=1",
      artist: "Harry styles",
      title: "Dream With Me",
    },
  ];
  ...
  return (
    <div>
      <div className="justify-between px-10 md:px-40 lg:px-60 py-24">
        <input
          type="text"
          className="bg-purple-white w-80 shadow rounded border-0 p-3"
          value={url}
